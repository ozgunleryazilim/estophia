...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0001_initial'),
        ('male', '0011_alter_maleserviceourcasestranslation_description'),
    ]

    operations = [
        migrations.CreateModel(
            name='MaleHowitworksPageSeo',
            fields=[
        ...
        migrations.CreateModel(
            name='MaleHowitworksPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='male.malehowitworkspageseo')),
            ],
            options={
                'verbose_name': 'How It Works Page SEO Translation',
                'db_table': 'male_malehowitworkspageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
