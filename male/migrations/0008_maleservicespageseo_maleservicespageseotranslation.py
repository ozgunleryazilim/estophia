...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0001_initial'),
        ('male', '0007_auto_20220626_1013'),
    ]

    operations = [
        migrations.CreateModel(
            name='MaleServicesPageSeo',
            fields=[
        ...
        migrations.CreateModel(
            name='MaleServicesPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='male.maleservicespageseo')),
            ],
            options={
                'verbose_name': 'Services SEO Translation',
                'db_table': 'male_maleservicespageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
