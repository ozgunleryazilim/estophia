...
class FemaleServiceCategory(base_models.BaseServiceCategory):
    gender = "female"
    translations = TranslatedFields(
...
class FemaleServiceItem(base_models.BaseServiceItem):
    ...
    category = models.ForeignKey(FemaleServiceCategory, on_delete=models.SET_NULL, blank=True, null=True,
...
class FemaleBeforeAfterCategory(base_models.BaseBeforeAfterCategory):
    gender = "female"
    translations = TranslatedFields(
...
class FemaleBeforeAfterItem(base_models.BaseBeforeAfterItem):
    gender = "female"
    category = models.ForeignKey(FemaleBeforeAfterCategory, blank=True, null=True, on_delete=models.SET_NULL,
