...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0001_initial'),
        ('female', '0015_femaleblog_view_count'),
    ]

    operations = [
        migrations.CreateModel(
            name='FemaleContactPageSeo',
            fields=[
        ...
        migrations.CreateModel(
            name='FemaleContactPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='female.femalecontactpageseo')),
            ],
            options={
                'verbose_name': 'Contact Page SEO Translation',
                'db_table': 'female_femalecontactpageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
