# Generated by Django 3.2 on 2022-06-26 20:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('common', '0001_initial'),
        ('female', '0013_femalebeforeafteritem_femalebeforeafterpageseo_femalebeforeafterpageseotranslation'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='female.femaleblog', verbose_name='Blog')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='female.femaleblogcategory', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='femaleblog',
            name='meta_keywords',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='female.femaleblog')),
            ],
            options={
                'verbose_name': 'Blog Translation',
                'db_table': 'female_femaleblog_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
        ...
        migrations.CreateModel(
            name='FemaleBlogsPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='female.femaleblogspageseo')),
            ],
            options={
                'verbose_name': 'Blogs Page SEO Translation',
                'db_table': 'female_femaleblogspageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
        ...
        migrations.CreateModel(
            name='FemaleBlogCategoryTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('title', models.CharField(max_length=200, verbose_name='Title')),
                ('slug', models.SlugField(max_length=200, verbose_name='Slug')),
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='female.femaleblogcategory')),
            ],
            options={
                'verbose_name': 'Blog Category Translation',
                'db_table': 'female_femaleblogcategory_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
                'unique_together': {('language_code', 'master')},
